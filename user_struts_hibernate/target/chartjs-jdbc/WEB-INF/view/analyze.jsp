...
<body>
			...
			<div id="right">
				<div class="right-serch">
					<div class="right-table">
						<div class="canvas1">
							<canvas id="userGenderChartCanvas" width="300" height="250"
								style="float: left;"></canvas>
						</div>
						<div class="canvas2">
							<canvas id="userCreateChartCanvas" width="300" height="250"
								style="float: left;"></canvas>
						</div>
    ...
    var userGenderChartConfig = {
        ...
        data: {
            labels: $ {
                userGenderData.names
            },
            datasets: [{
                data: $ {
                    userGenderData.values
                },
